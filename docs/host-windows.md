...
Клиент показывает баннер «Admin window: input is blocked by Windows» с
...
Значок в трее — статус (PIN / активная сессия / офлайн), меню: «Copy PIN»,
«End session», «Open log» (открывает лог в Блокноте), «Quit rcdesk».
