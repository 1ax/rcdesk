...
- ▶️ **Первое дело нового чата — живая проверка ввода** (`serve` без `--no-input`, управлять
  из второго окна/устройства), затем **слайс 2.1: хост на Windows 10 x64** (физический ПК
...
- Окружение владельца: Apple M4 / macOS 26.6 / Chrome 153 / Safari 26.6, Rust 1.98 в
  `~/.cargo/bin`, разрешения «Запись экрана» и «Универсальный доступ» выданы терминалу (2026-09-11).
