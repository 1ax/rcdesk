...
**Состояние на 2026-09-21 (седьмой чат: слайс 3.1 проверен владельцем, два фикса по итогам):**
- ✅ **Живая проверка 3.1 (владелец, 2026-09-21, Deploy `35532583642`):** подключение из списка без PIN, имя после
  ...
  Теперь хост перезапрашивает ключевой кадр раз в 500 мс до первого RR с нашим SSRC (≤ 15 с). **Проверка фикса на
  стенде — за владельцем** (новый exe, несколько подключений подряд к статичному экрану).
