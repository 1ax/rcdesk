...
- ▶️ **Следующее: 3.2b** — выбор и разведка PAKE (SPAKE2 vs OPAQUE, крейты, где хранить верификатор на хосте,
  как встроить в сигналинг до `Offer`) и отпечаток DTLS в клиенте. Развилки — владельцу перед «go».
- **Решение владельца 2026-09-22:** порядок фазы 3 — 3.2, затем 3.4 (файлы); D35 взят первым под-шагом 3.2.
...
**За владельцем:**
- `git push` (кодовые и docs-коммиты 3.5g/3.5h и 3.2a).
