...
**За владельцем:**
- Mac с реальным захватом после 2.4 — проверен частично (2026-09-15): `list-displays` отдаёт настоящий
  `3 LG IPS FULLHD 1920x1080@0,0 primary`, конвейер стартует на VideoToolbox 1920×1080, но сеанс до картинки
  не дошёл из-за D26 (нет «Универсального доступа» у родительского приложения). С `--no-input` сеанс живёт.
  Досмотреть мышь по `CGDisplayBounds` — после фикса D26.
